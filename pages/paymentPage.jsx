...
const PaymentPage = () => {
    return(
        ...
        <Link href      = "/Orders/213"><button className                                                       = {styles.button_orange}>CASH ON DELIVERY</button></Link>
        <Link href      = "https://developer.paypal.com/docs/payouts/standard/integrate-api/"><button className = {styles.button}><span className                     = {styles.text}>Pay</span><span className = {styles.textB}>Pal</span></button></Link>
        </div>
                </div>
            </div>
        </div>
